...
| CM-012 | Human oversight | Critical actions require approval | Approval engine and Knowledge Base write/edit approval dry-run with command hashing before persistence | `tests/test_knowledge_base.py`, `tests/test_api.py`, approval workflow tests | partial |
