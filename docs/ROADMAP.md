...
146. [ ] Legacy-SQL-Connector-Metadata-Connection-Probe-Live-Adapter haerten: echten SQL-Server/Postgres-Provider hinter dem Skeleton mit Secret-Broker-Materialisierung, freigegebener Netzwerkroute, Redaction/Audit, Timeout-/Circuit-Breaker und Emergency-Stop in einem isolierten Worker aktivieren, weiterhin ohne Rohdaten, Import-Dry-Run oder Writes.
