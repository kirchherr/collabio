...
144. [ ] Legacy-SQL-Connector-Metadata-Connection-Probe-Gate vorbereiten: Live-Connection-Gate-Ergebnis, echten Provider-Treiber, Secret-Broker-Read-Path, Metadata-Query-Allowlist, Timeout-/Circuit-Breaker-Ausfuehrung, Audit-Sink und Emergency-Disable als eng begrenztes Ausfuehrungsgate binden, bevor ein erster echter metadata-only Probe implementiert wird.
