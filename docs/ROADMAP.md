...
- [ ] Parallel ueber den neuen Security-Admin-Read-Pfad die aktuellen Anforderungen und den fail-closed Status pruefen; verantwortliche Operations-Stellen liefern danach reale Produktions-Topologie-, PITR-, Offsite-Restore-, HA-Promotion- und Cross-Site-Failover-Evidenz fuer `production_continuity_deployment_gate.v1`. Ohne gruenen hashgueltigen Report bleibt selbst ein gesetzter Runtime-Schalter wirkungslos.
