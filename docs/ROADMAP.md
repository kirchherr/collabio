...
- [ ] Naechster Fokus: Realnutzer-Pilot separat aufnehmen. Benannte Principals, Zweck, Rollen, aktuelle Kontrollnachweise und neue Vier-Augen-Freigaben sind erforderlich; Entwicklungs-Admission, Startfreigabe und Runtime-Window werden nicht wiederverwendet.
