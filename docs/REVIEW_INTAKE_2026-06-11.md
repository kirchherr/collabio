...
1. Persist the PrincipalResolver, tenant membership, role, group, ACL and ABAC stores in PostgreSQL with RLS and audit events.
2. Move replay state from JSON file to PostgreSQL or another durable low-latency store with audit events.
