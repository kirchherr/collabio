...
- Search Readiness: `app/suite/platform/crm_erp_search_readiness.py`, `GET /v1/platform/search/crm-erp/readiness` und `GET /v1/platform/search/crm-erp/rag-readiness`, `POST /v1/platform/search/crm-erp/source-resolver-acl-trace`, `POST /v1/platform/search/crm-erp/source-citation-contract`, `POST /v1/platform/search/crm-erp/prompt-audit-contract`
