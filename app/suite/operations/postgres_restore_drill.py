...
PRODUCTIVITY_PILOT_START_AUTHORIZATION_TABLES = {
    ...
    "collabio.productivity_pilot_real_user_closure_reports",
}
...
def build_postgres_database_snapshot(
    *,
    ...
    normalized = {
        ...
        "column_grants": _normalized_rows(column_grants),
    }
    ...
    draft = PostgresDatabaseSnapshot(
        ...
        office_document_controls_verified=office_document_verified,
...
def build_postgres_restore_drill_report(
    *,
    ...
    control_pairs = {
        "office_document_controls_verified": (
            source_snapshot.office_document_controls_verified and target_snapshot.office_document_controls_verified
        ),
    ...
    checks = {
        "office_document_controls_not_verified": control_pairs["office_document_controls_verified"],
    ...
    draft = PostgresRestoreDrillReport(
        ...
        office_document_controls_verified=control_pairs["office_document_controls_verified"],
