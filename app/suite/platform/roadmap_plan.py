...
def _roadmap_plan_items(*, dashboard: RoadmapDashboardResponse) -> tuple[RoadmapPlanItem, ...]:
    return (
        ...
        RoadmapPlanItem(
            ...
            summary=(
                "ACL-first Keyword-Suche, Source-Resolver, Citation-Contract und Prompt-Audit stehen; "
                "RAG wartet auf Redaction und autorisierten Kontextaufbau."
            ),
            ...
            decision="next_because_prompt_audit_is_safe_but_rag_must_wait_for_redaction",
            evidence_refs=(
