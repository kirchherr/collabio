            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    summary=(
                        ...
                        "und Dry-run-Execution-Skeleton, Executor-Implementation-Review, Result-Contract und "
                        "Execution-Gate sind metadata-only bereit; die Dry-run-Execution-Request-Boundary bleibt "
                        "naechster Schritt."
                    ),
                    status=RoadmapCapabilityStatus.METADATA_ONLY,
                    ...
                    next_action="prepare_tickets_incidents_activation_dry_run_execution_request_boundary_without_execution",
                ),
                RoadmapCapability(
