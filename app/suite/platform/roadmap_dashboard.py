            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    summary=(
                        ...
                        "Boundary und Dry-run-Execution-Activation-Boundary sind metadata-only bereit; "
                        "naechster Schritt ist die Dry-run-Execution-Start-Boundary."
                    ),
                    status=RoadmapCapabilityStatus.METADATA_ONLY,
                    ...
                    next_action="prepare_tickets_incidents_activation_dry_run_execution_start_boundary_without_execution",
                ),
                RoadmapCapability(
