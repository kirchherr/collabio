        ...
        RoadmapCapabilityGroup(
            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    api_routes=("/v1/crm-erp/search", "/v1/platform/search/crm-erp/readiness"),
                    guardrails=(
                    ...
                    next_action="rag_only_after_search_readiness_source_citation_and_acl_revalidation_gate",
                ),
            ),
        ),
        RoadmapCapabilityGroup(
