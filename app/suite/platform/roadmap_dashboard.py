            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    summary=(
                        ...
                        "Eine gespeicherte Fassung kann nach frischer Lese- und Erstellungspruefung als "
                        ...
                        "fuer Auswahl oder folgende Eingabe. "
                ...
                RoadmapCapability(
                    ...
                    summary=(
                        ...
                        "fuer alle drei synthetischen Fixtures Evidence erzeugt: die gleichen Engine-Render sind "
                        "pixelgleich, waehrend der echte Open-XML-SDK-Validator sechs bis sieben Schemafindings "
                        "belegt. Eine private-key-freie, netzlose Ergebniszeremonie bindet eine "
                    ...
                    guardrails=(
                        ...
                        "real_signed_and_byte_verified_libreoffice_row_does_not_grant_compatibility",
                        "libreoffice_signed_row_is_three_of_nine_matrix_assignments",
                        ...
                        "word_execution_requires_isolated_nonproduction_windows_vm",
                        "operator_workstation_word_assignment_is_diagnostic_only",
        ...
        RoadmapCapabilityGroup(
            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    title="Knowledge Base im Arbeitsbereich",
                    summary="Artikel lesen, erstellen und versioniert bearbeiten mit expliziter Freigabe in /work.",
                    status=RoadmapCapabilityStatus.GUARDED,
                    capability_type="guarded_product_workflow",
                    evidence_refs=(
                        "tests/test_knowledge_base.py",
                        "tests/test_knowledge_base_write_unit_of_work.py",
                        "e2e/work/tests/knowledge.spec.mjs",
                        "docs/modules/KNOWLEDGE_BASE_READER_VERTICAL_SLICE.md",
                        "docs/modules/KNOWLEDGE_BASE_ARTICLES_VERTICAL_SLICE.md",
                    ),
                    api_routes=(
                        "/work",
                        "/v1/kb/articles",
                        "/v1/kb/articles/{article_object_id}/content",
                    ...
                    guardrails=(
                        ...
                        "tenant_admin_and_enabled_write_feature_required",
                        "authoritative_article_version_acl_required",
                        "reader_requires_read_feature_without_write_role",
                        "rag_and_search_indexing_disabled",
                    ),
                ),
                RoadmapCapability(
                    ...
                    summary=(
                        ...
                        "gemeinsamer ACL-gepruefter Account-Workflow gelesen; /work zeigt Konto, Kontakte "
                        "und Aktivitaeten."
                    ),
                    status=RoadmapCapabilityStatus.OPERATIONAL,
