            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    summary=(
                        ...
                        "Boundary, Dry-run-Execution-Activation-Boundary und Dry-run-Execution-Start-Boundary "
                        "sind metadata-only bereit; naechster Schritt ist die Dry-run-Execution-Dispatch-Boundary."
                    ),
                    status=RoadmapCapabilityStatus.METADATA_ONLY,
                    ...
                    next_action="prepare_tickets_incidents_activation_dry_run_execution_dispatch_boundary_without_execution",
                ),
                RoadmapCapability(
