        ...
        RoadmapCapabilityGroup(
            ...
            capabilities=(
                ...
                RoadmapCapability(
                    ...
                    summary="CRM Accounts, Contacts, Activities/Notes und ERP Products sind tenant-sichere Slices.",
                    status=RoadmapCapabilityStatus.METADATA_ONLY,
                    ...
                    api_routes=("/v1/crm/accounts", "/v1/crm/contacts", "/v1/crm/activities", "/v1/erp/products"),
                    guardrails=("module_gate_required", "tenant_context_required", "no_ai_bypass"),
                    next_action="crm_erp_orders_invoices_and_search_acl_first",
                ),
            ),
        ),
        RoadmapCapabilityGroup(
