...
def test_lms_foundation_registers_catalog_entry_without_install_or_tenant_activation() -> None:
    ...
    assert catalog_entry.required_migration_versions == ("0045", "0046", "0047", "0048", "0049")
...
def test_lms_module_charter_documents_contract_gates_and_deferred_scope() -> None:
    ...
    for expected in (
        ...
        "package-installation-dry-run-execution-admission-gate",
        "package-installation-dry-run-execution-runbook",
        "package-installation-dry-run-execution-plan",
        "package-installation-dry-run-execution-plan-review",
        "package-installation-dry-run-execution-scheduler-boundary",
        "package-installation-dry-run-execution-worker-image-boundary",
        "SCORM/xAPI runtime",
    ):
