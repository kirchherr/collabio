...
from suite.platform.tickets_incidents_activation_dry_run_execution_preflight import (
    ...
    TicketsIncidentsActivationDryRunExecutionPreflightCommand,
    build_tickets_incidents_activation_dry_run_execution_preflight_response,
)
from suite.platform.tickets_incidents_activation_dry_run_execution_receipt_boundary import (
    TICKETS_INCIDENTS_ACTIVATION_DRY_RUN_EXECUTION_RECEIPT_BOUNDARY_STATEMENT,
    TicketsIncidentsActivationDryRunExecutionReceiptBoundaryCommand,
    build_tickets_incidents_activation_dry_run_execution_receipt_boundary_response,
)
from suite.platform.tickets_incidents_activation_dry_run_result_persistence_boundary import (
    ...
    TicketsIncidentsActivationDryRunResultPersistenceBoundaryCommand,
    build_tickets_incidents_activation_dry_run_result_persistence_boundary_hash,
    build_tickets_incidents_activation_dry_run_result_persistence_boundary_response,
)
...
def _approval_command(
    ...
    return TicketsIncidentsTenantAdminActivationApprovalRecordCommand(
        ...
        approval_record_ref="tickets-approval:dry-run-result-persistence-boundary-demo",
        approval_ticket_ref="ticket:tickets-dry-run-result-persistence-boundary-demo",
        human_confirmation_reference="confirmation:tickets-dry-run-result-persistence-boundary-demo",
        human_confirmation_statement=TICKETS_INCIDENTS_TENANT_ADMIN_ACTIVATION_APPROVAL_RECORD_CONFIRMATION_STATEMENT,
        change_request_ref="change:tickets-dry-run-result-persistence-boundary-demo",
        idempotency_key_ref="idempotency:tickets-dry-run-result-persistence-boundary-demo",
        approved_at_utc=datetime(2026, 7, 9, 8, 0, tzinfo=UTC),
        audit_chain_ref="audit:tickets-dry-run-result-persistence-boundary-demo",
    )
...
def _dry_run_execution_preflight_command(
    *,
    ...
    activation_dry_run_execution_skeleton_hash: str,
    activation_dry_run_executor_implementation_review_hash: str,
    activation_dry_run_result_contract_hash: str,
    activation_dry_run_execution_gate_hash: str,
    activation_dry_run_execution_request_boundary_hash: str,
    activation_dry_run_executor_runtime_boundary_hash: str,
    ...
    return TicketsIncidentsActivationDryRunExecutionPreflightCommand(
        ...
        activation_dry_run_execution_preflight_ref="tickets-activation-dry-run-execution-preflight:receipt-demo",
        change_request_ref="change:tickets-activation-dry-run-execution-preflight-receipt-demo",
        idempotency_key_ref="idempotency:tickets-activation-dry-run-execution-preflight-receipt-demo",
        prepared_at_utc=datetime(2026, 7, 9, 8, 50, tzinfo=UTC),
        audit_chain_ref="audit:tickets-activation-dry-run-execution-preflight-receipt-demo",
        activation_dry_run_execution_preflight_statement=TICKETS_INCIDENTS_ACTIVATION_DRY_RUN_EXECUTION_PREFLIGHT_STATEMENT,
    )
...
def _dry_run_execution_receipt_boundary_command(
    *,
    ...
    activation_dry_run_execution_request_boundary_hash: str,
    activation_dry_run_executor_runtime_boundary_hash: str,
    activation_dry_run_execution_preflight_hash: str,
    activation_execution_boundary_hash: str,
    activation_executor_skeleton_hash: str,
    approval_gate_hash: str,
    approval_record_hash: str,
) -> TicketsIncidentsActivationDryRunExecutionReceiptBoundaryCommand:
    return TicketsIncidentsActivationDryRunExecutionReceiptBoundaryCommand(
        activation_dry_run_plan_evidence_hash=activation_dry_run_plan_hash,
        activation_dry_run_execution_boundary_evidence_hash=activation_dry_run_execution_boundary_hash,
        activation_dry_run_execution_skeleton_evidence_hash=activation_dry_run_execution_skeleton_hash,
        activation_dry_run_executor_implementation_review_evidence_hash=(
        ...
        activation_dry_run_execution_receipt_boundary_ref=(
            "tickets-activation-dry-run-execution-receipt-boundary:persistence-demo"
        ),
        change_request_ref="change:tickets-activation-dry-run-execution-receipt-boundary-persistence-demo",
        idempotency_key_ref="idempotency:tickets-activation-dry-run-execution-receipt-boundary-persistence-demo",
        prepared_at_utc=datetime(2026, 7, 9, 8, 55, tzinfo=UTC),
        audit_chain_ref="audit:tickets-activation-dry-run-execution-receipt-boundary-persistence-demo",
        activation_dry_run_execution_receipt_boundary_statement=(
            TICKETS_INCIDENTS_ACTIVATION_DRY_RUN_EXECUTION_RECEIPT_BOUNDARY_STATEMENT
        ),
    )


def _dry_run_result_persistence_boundary_command(
    *,
    activation_dry_run_plan_hash: str,
    activation_dry_run_execution_boundary_hash: str,
    activation_dry_run_execution_skeleton_hash: str,
    ...
    activation_dry_run_executor_runtime_boundary_hash: str,
    activation_dry_run_execution_preflight_hash: str,
    activation_dry_run_execution_receipt_boundary_hash: str,
    activation_execution_boundary_hash: str,
    activation_executor_skeleton_hash: str,
    approval_gate_hash: str,
    approval_record_hash: str,
    ...
    return TicketsIncidentsActivationDryRunResultPersistenceBoundaryCommand(
        activation_dry_run_plan_evidence_hash=activation_dry_run_plan_hash,
        activation_dry_run_execution_boundary_evidence_hash=activation_dry_run_execution_boundary_hash,
        activation_dry_run_execution_skeleton_evidence_hash=activation_dry_run_execution_skeleton_hash,
        activation_dry_run_executor_implementation_review_evidence_hash=(
        ...
        activation_dry_run_result_persistence_boundary_ref=(
            "tickets-activation-dry-run-result-persistence-boundary:demo"
        ),
        change_request_ref="change:tickets-activation-dry-run-result-persistence-boundary-demo",
        idempotency_key_ref="idempotency:tickets-activation-dry-run-result-persistence-boundary-demo",
        prepared_at_utc=datetime(2026, 7, 9, 8, 55, tzinfo=UTC),
        audit_chain_ref="audit:tickets-activation-dry-run-result-persistence-boundary-demo",
...
def test_tickets_incidents_activation_dry_run_result_persistence_boundary_is_metadata_only_after_receipt() -> None:
    ...
    preflight = build_tickets_incidents_activation_dry_run_execution_preflight_response(
        command=_dry_run_execution_preflight_command(
            activation_dry_run_plan_hash=_fake_hash("1"),
            activation_dry_run_execution_boundary_hash=_fake_hash("2"),
            activation_dry_run_execution_skeleton_hash=_fake_hash("3"),
            activation_dry_run_executor_implementation_review_hash=_fake_hash("4"),
            activation_dry_run_result_contract_hash=_fake_hash("5"),
            activation_dry_run_execution_gate_hash=_fake_hash("6"),
            activation_dry_run_execution_request_boundary_hash=_fake_hash("7"),
            activation_dry_run_executor_runtime_boundary_hash=_fake_hash("8"),
            activation_execution_boundary_hash=_fake_hash("9"),
            activation_executor_skeleton_hash=_fake_hash("a"),
    ...
    receipt_boundary = build_tickets_incidents_activation_dry_run_execution_receipt_boundary_response(
        command=_dry_run_execution_receipt_boundary_command(
            ...
            activation_dry_run_execution_request_boundary_hash=_fake_hash("7"),
            activation_dry_run_executor_runtime_boundary_hash=_fake_hash("8"),
            activation_dry_run_execution_preflight_hash=preflight.evidence_hash,
            activation_execution_boundary_hash=_fake_hash("9"),
            activation_executor_skeleton_hash=_fake_hash("a"),
            approval_gate_hash=approval_gate.evidence_hash,
            approval_record_hash=approval_record.evidence_hash,
    ...
    response = build_tickets_incidents_activation_dry_run_result_persistence_boundary_response(
        command=_dry_run_result_persistence_boundary_command(
            activation_dry_run_plan_hash=_fake_hash("1"),
            activation_dry_run_execution_boundary_hash=_fake_hash("2"),
            activation_dry_run_execution_skeleton_hash=_fake_hash("3"),
            activation_dry_run_executor_implementation_review_hash=_fake_hash("4"),
            ...
            activation_dry_run_executor_runtime_boundary_hash=_fake_hash("8"),
            activation_dry_run_execution_preflight_hash=preflight.evidence_hash,
            activation_dry_run_execution_receipt_boundary_hash=receipt_boundary.evidence_hash,
            activation_execution_boundary_hash=_fake_hash("9"),
            activation_executor_skeleton_hash=_fake_hash("a"),
            approval_gate_hash=approval_gate.evidence_hash,
            approval_record_hash=approval_record.evidence_hash,
    ...
    assert response.schema_version == TICKETS_INCIDENTS_ACTIVATION_DRY_RUN_RESULT_PERSISTENCE_BOUNDARY_SCHEMA_VERSION
    assert response.endpoint == TICKETS_INCIDENTS_ACTIVATION_DRY_RUN_RESULT_PERSISTENCE_BOUNDARY_ENDPOINT
    assert response.result_contract == TICKETS_INCIDENTS_ACTIVATION_DRY_RUN_RESULT_PERSISTENCE_BOUNDARY_RESULT_CONTRACT
    ...
    assert response.activation_dry_run_plan_evidence_hash == _fake_hash("1")
    assert response.activation_dry_run_execution_boundary_evidence_hash == _fake_hash("2")
    assert response.activation_dry_run_execution_skeleton_evidence_hash == _fake_hash("3")
    assert response.activation_dry_run_executor_implementation_review_evidence_hash == _fake_hash("4")
    assert response.activation_dry_run_result_contract_evidence_hash == _fake_hash("5")
    assert response.activation_dry_run_execution_gate_evidence_hash == _fake_hash("6")
    assert response.activation_dry_run_execution_request_boundary_evidence_hash == _fake_hash("7")
    assert response.activation_dry_run_executor_runtime_boundary_evidence_hash == _fake_hash("8")
    assert response.activation_dry_run_execution_preflight_evidence_hash == preflight.evidence_hash
    assert response.activation_dry_run_execution_receipt_boundary_evidence_hash == receipt_boundary.evidence_hash
    assert response.activation_execution_boundary_evidence_hash == _fake_hash("9")
    assert response.activation_executor_skeleton_evidence_hash == _fake_hash("a")
    ...
    assert response.activation_dry_run_result_persistence_boundary_statement_hash.startswith("sha256:")
    assert response.preparer_role_allowed is True
    assert response.activation_dry_run_result_persistence_boundary_requested is True
    assert response.activation_dry_run_result_persistence_boundary_ready is True
    assert response.future_activation_dry_run_execution_activation_boundary_required is True
    ...
    assert "bind_tickets_activation_dry_run_execution_receipt_boundary_hash" in (
        response.activation_dry_run_result_persistence_boundary_steps
    )
    assert "define_activation_boundary_required_before_any_dry_run_result_write" in (
        response.activation_dry_run_result_persistence_boundary_steps
    )
    assert "future_activation_dry_run_execution_activation_boundary_required" in (
        response.required_activation_dry_run_result_persistence_boundary_evidence
    )
    assert response.blocking_reasons == ()
    assert response.evidence_hash == build_tickets_incidents_activation_dry_run_result_persistence_boundary_hash(
        response
    )
    assert (
...
def test_tickets_incidents_activation_dry_run_result_persistence_boundary_blocks_execution_request() -> None:
    module_registry = default_module_registry()
    ...
    response = build_tickets_incidents_activation_dry_run_result_persistence_boundary_response(
        command=_dry_run_result_persistence_boundary_command(
            ...
            approval_gate_hash=_fake_hash("8"),
            approval_record_hash=_fake_hash("9"),
    ...
    assert response.activation_dry_run_result_persistence_boundary_ready is False
